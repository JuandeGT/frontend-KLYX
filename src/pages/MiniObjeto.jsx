...
// Aparece en el modal cuando el usuario aún no ha abierto — le muestra qué puede ganar.
const MiniObjeto = ({ objeto: o }) => {
	...
	const porcentaje = (probabilidad !== null && probabilidad !== undefined && typeof probabilidad !== 'object')
		? String(probabilidad)
		: '?';
	...
	return (
		<div className="mini-objeto" title={`${o.nombre} — ${porcentaje}%`}>
			<div className="mini-objeto-img">
				{o.imagen && <img src={o.imagen} alt={o.nombre} />}
			</div>
