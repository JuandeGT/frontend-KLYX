...
// Al hacer clic en cualquier parte o en el botón se abren los detalles de la caja
const TarjetaCaja = ({ caja, onVerDetalles }) => (
	<div className="tarjeta-caja" onClick={onVerDetalles}>
		...
		<div className="tarjeta-caja-imagen">{caja.imagen && <img src={caja.imagen} alt={caja.nombre} />}</div>
