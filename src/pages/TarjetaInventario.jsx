...
const TarjetaInventario = ({ objeto }) => {
	...
	// Navega a CrearIntercambio pasando el objeto pre-seleccionado via location.state,
	// así el formulario arranca con ese objeto ya elegido y tipo 'venta'
	...
	return (
		<div className="tarjeta-objeto-inventario">
			<div className="objeto-imagen-inventario">
				{objeto.imagen && <img src={objeto.imagen} alt={objeto.nombre} />}
			</div>
			...
			<div className="objeto-info-inventario">
				...
				{objeto.precio > 0 && (
					<p className="objeto-precio-inventario">{formatearKC(objeto.precio)}</p>
				)}
